...
import vn.truonggiang.exception.StorageException;
import vn.truonggiang.exception.StorageFileNotFoundException;
...
public class FileSystemStorageServiceImpl implements IStorageService {
    ...
    public void init() {
        try {
            ...
            System.out.println("Storage location: " + rootLocation.toString());
        } catch (Exception e) {
